...
public class LessEqualOperatorFactory implements OperatorFactory {
    ...
    public DynamicValue buildFunction(final List<DynamicValue> dynamicValueList) {
        return LessEqualOperator.from(dynamicValueList);
    }
    ...
    public static class LessEqualOperator extends AbstractDynamicValue {
        ...
        private LessEqualOperator(final List<DynamicValue> dynamicValueList) {
            super(dynamicValueList);
        }

        public static LessEqualOperator from(final List<DynamicValue> dynamicValueList) {
