 ...
 * @Since
 **/
public class GreaterEqualExtOperation extends AbstractFunctionDynamicValue implements DynamicValue {

    public GreaterEqualExtOperation(final DynamicValue param) {
        super(param);
    }
