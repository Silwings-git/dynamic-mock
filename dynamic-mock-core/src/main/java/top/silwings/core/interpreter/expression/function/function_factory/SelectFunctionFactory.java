...
import top.silwings.core.interpreter.expression.function.FunctionExpression;
...
public class SelectFunctionFactory implements FunctionFactory {
    ...
    @Override
    public FunctionExpression buildFunction(final List<Expression> functionExpressionList) {
    ...
    public static class SelectFunction extends AbstractFunctionExpression {
        ...
        public SelectFunction(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        public static SelectFunction from(final List<Expression> functionExpressionList) {
