...
public class UUIDFunctionFactory implements FunctionFactory {
    ...
    @Override
    public UUIDFunction buildFunction(final List<ExpressionTreeNode> functionExpressionList) {
        CheckUtils.sizeBetween(functionExpressionList, UUID_FUNCTION_INFO.getMinArgsNumber(), UUID_FUNCTION_INFO.getMaxArgsNumber(), DynamicValueCompileException.supplier("Wrong number of parameters of UUID function."));
        return UUIDFunction.from(functionExpressionList);
    }
     ...
     */
    public static class UUIDFunction extends AbstractFunctionExpression {

        private UUIDFunction(final List<ExpressionTreeNode> functionExpressionList) {
            super(functionExpressionList);
        }

        private static UUIDFunction from(final List<ExpressionTreeNode> functionExpressionList) {
            return new UUIDFunction(functionExpressionList);
        }
