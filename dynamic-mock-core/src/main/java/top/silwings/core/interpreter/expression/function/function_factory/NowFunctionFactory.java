...
public class NowFunctionFactory implements FunctionFactory {
    ...
    @Override
    public NowFunction buildFunction(final List<Expression> functionExpressionList) {
    ...
    public static class NowFunction extends AbstractFunctionExpression {
        ...
        private NowFunction(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        private static NowFunction from(final List<Expression> functionExpressionList) {
