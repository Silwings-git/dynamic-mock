...
public class IsNotEmptyFunctionFactory implements FunctionFactory {
    ...
    @Override
    public IsNotEmptyFunction buildFunction(final List<Expression> functionExpressionList) {
    ...
    public static class IsNotEmptyFunction extends AbstractFunctionExpression {
        ...
        private IsNotEmptyFunction(final List<Expression> functionExpressionList, final IsEmptyFunctionFactory.IsEmptyFunction isEmptyFunction) {
            super(functionExpressionList);
            this.isEmptyFunction = isEmptyFunction;
        }

        private static IsNotEmptyFunction from(final List<Expression> functionExpressionList, final IsEmptyFunctionFactory isEmptyFunctionFactory) {
