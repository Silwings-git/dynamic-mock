...
public class SaveCacheFunctionFactory implements FunctionFactory {
    ...
    @Override
    public SaveCacheFunction buildFunction(final List<Expression> functionExpressionList) {
    ...
    public static class SaveCacheFunction extends AbstractFunctionExpression {
        ...
        public SaveCacheFunction(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        public static SaveCacheFunction from(final List<Expression> functionExpressionList) {
