...
public class UUIDFunctionFactory implements FunctionFactory {
    ...
    @Override
    public UUIDFunction buildFunction(final List<Expression> functionExpressionList) {
    ...
    public static class UUIDFunction extends AbstractFunctionExpression {
        ...
        private UUIDFunction(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        private static UUIDFunction from(final List<Expression> functionExpressionList) {
