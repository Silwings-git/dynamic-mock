...
public class SubtractionOperatorFactory implements OperatorFactory {
    ...
    public static class SubtractionOperator extends AbstractOperatorExpression {
        ...
        private SubtractionOperator(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        public static SubtractionOperator from(final List<Expression> functionExpressionList) {
