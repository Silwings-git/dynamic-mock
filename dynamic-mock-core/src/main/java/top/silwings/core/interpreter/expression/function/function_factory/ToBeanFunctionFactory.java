...
public class ToBeanFunctionFactory implements FunctionFactory {
    ...
    @Override
    public ToBeanFunction buildFunction(final List<Expression> functionExpressionList) {
    ...
    public static class ToBeanFunction extends AbstractFunctionExpression {
        ...
        protected ToBeanFunction(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        public static ToBeanFunction form(final List<Expression> functionExpressionList) {
