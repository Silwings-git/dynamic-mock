package top.silwings.core.interpreter.expression;
...
import top.silwings.core.interpreter.expression.terminal.MultipleTerminalExpression;
import top.silwings.core.interpreter.expression.terminal.SingleTerminalNode;
...
public class ExpressionFactory {
    ...
    public Expression buildDynamicValue(final String expression, final DynamicExpressionFactory dynamicExpressionFactory) {
        ...
        if (commaPriorityResult.hasCommaPriority()) {
            final List<Expression> functionExpressionList = commaPriorityResult.getList().stream().map(dynamicExpressionFactory::buildDynamicValue).collect(Collectors.toList());
