...
public class RemainderOperatorFactory implements OperatorFactory {
    ...
    public static class RemainderOperator extends AbstractOperatorExpression {
        ...
        private RemainderOperator(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        public static RemainderOperator from(final List<Expression> functionExpressionList) {
