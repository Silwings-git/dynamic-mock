...
public class ArithmeticNoEqualOperatorFactory implements OperatorFactory {
    ...
    public static class ArithmeticNoEqualOperator extends AbstractOperatorExpression {
        ...
        private ArithmeticNoEqualOperator(final List<Expression> functionExpressionList, final ArithmeticEqualOperatorFactory arithmeticEqualOperatorFactory) {
        ...
        public static ArithmeticNoEqualOperator of(final List<Expression> functionExpressionList, final ArithmeticEqualOperatorFactory arithmeticEqualOperatorFactory) {
