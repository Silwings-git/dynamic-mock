...
public class ConcatFunctionFactory implements FunctionFactory {
    ...
    @Override
    public ConcatFunction buildFunction(final List<Expression> functionExpressionList) {
    ...
    public static class ConcatFunction extends AbstractFunctionExpression {
        ...
        private ConcatFunction(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        private static ConcatFunctionFactory.ConcatFunction from(final List<Expression> functionExpressionList) {
