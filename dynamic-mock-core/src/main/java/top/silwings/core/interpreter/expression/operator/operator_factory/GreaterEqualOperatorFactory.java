...
public class GreaterEqualOperatorFactory implements OperatorFactory {
    ...
    public static class GreaterEqualOperator extends AbstractOperatorExpression {
        ...
        private GreaterEqualOperator(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        public static GreaterEqualOperator from(final List<Expression> functionExpressionList) {
