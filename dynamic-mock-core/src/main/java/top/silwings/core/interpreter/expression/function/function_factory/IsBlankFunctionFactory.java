...
public class IsBlankFunctionFactory implements FunctionFactory {
    ...
    @Override
    public IsBlankFunction buildFunction(final List<Expression> functionExpressionList) {
    ...
    public static class IsBlankFunction extends AbstractFunctionExpression {
        ...
        private IsBlankFunction(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        private static IsBlankFunction from(final List<Expression> functionExpressionList) {
