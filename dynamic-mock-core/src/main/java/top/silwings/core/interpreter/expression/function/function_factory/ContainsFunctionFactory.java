...
public class ContainsFunctionFactory implements FunctionFactory {
    ...
    @Override
    public ContainsFunction buildFunction(final List<Expression> functionExpressionList) {
    ...
    public static class ContainsFunction extends AbstractFunctionExpression {
        ...
        public ContainsFunction(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        public static ContainsFunction from(final List<Expression> functionExpressionList) {
