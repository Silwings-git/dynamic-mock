...
public class IsNotNullFunctionFactory implements FunctionFactory {
    ...
    @Override
    public IsNotNullFunction buildFunction(final List<Expression> functionExpressionList) {
    ...
    public static class IsNotNullFunction extends AbstractFunctionExpression {
        ...
        private IsNotNullFunction(final List<Expression> functionExpressionList, final IsNullFunctionFactory.IsNullFunction isNullFunction) {
            super(functionExpressionList);
            this.isNullFunction = isNullFunction;
        }

        private static IsNotNullFunction from(final List<Expression> functionExpressionList, final IsNullFunctionFactory.IsNullFunction isNullFunction) {
