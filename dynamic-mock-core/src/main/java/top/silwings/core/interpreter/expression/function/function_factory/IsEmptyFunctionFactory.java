...
public class IsEmptyFunctionFactory implements FunctionFactory {
    ...
    @Override
    public IsEmptyFunction buildFunction(final List<Expression> functionExpressionList) {
    ...
    public static class IsEmptyFunction extends AbstractFunctionExpression {
        ...
        private IsEmptyFunction(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        private static IsEmptyFunction from(final List<Expression> functionExpressionList) {
