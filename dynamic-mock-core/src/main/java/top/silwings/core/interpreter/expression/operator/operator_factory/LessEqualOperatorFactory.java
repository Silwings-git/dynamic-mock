...
public class LessEqualOperatorFactory implements OperatorFactory {
    ...
    public static class LessEqualOperator extends AbstractOperatorExpression {
        ...
        private LessEqualOperator(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        public static LessEqualOperator from(final List<Expression> functionExpressionList) {
