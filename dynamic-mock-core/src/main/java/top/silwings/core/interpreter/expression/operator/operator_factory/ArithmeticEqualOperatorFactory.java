...
public class ArithmeticEqualOperatorFactory implements OperatorFactory {
    ...
    public static class ArithmeticEqualOperator extends AbstractOperatorExpression {
        ...
        private ArithmeticEqualOperator(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        public static ArithmeticEqualOperator from(final List<Expression> functionExpressionList) {
