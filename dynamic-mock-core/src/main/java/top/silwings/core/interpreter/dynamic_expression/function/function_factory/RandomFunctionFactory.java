...
public class RandomFunctionFactory implements FunctionFactory {
    ...
    @Override
    public RandomFunction buildFunction(final List<ExpressionTreeNode> functionExpressionList) {
    ...
    public static class RandomFunction extends AbstractFunctionExpression {
        ...
        private RandomFunction(final List<ExpressionTreeNode> functionExpressionList) {
            super(functionExpressionList);
        }

        private static RandomFunction from(final List<ExpressionTreeNode> functionExpressionList) {
