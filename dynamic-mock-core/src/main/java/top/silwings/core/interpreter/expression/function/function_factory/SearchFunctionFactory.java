...
public class SearchFunctionFactory implements FunctionFactory {
    ...
    @Override
    public SearchFunction buildFunction(final List<Expression> functionExpressionList) {
    ...
    public static class SearchFunction extends AbstractFunctionExpression {
        ...
        private SearchFunction(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        private static SearchFunction from(final List<Expression> functionExpressionList) {
