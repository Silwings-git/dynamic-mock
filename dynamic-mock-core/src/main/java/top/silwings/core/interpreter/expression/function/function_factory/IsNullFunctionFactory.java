...
public class IsNullFunctionFactory implements FunctionFactory {
    ...
    @Override
    public IsNullFunction buildFunction(final List<Expression> functionExpressionList) {
    ...
    public static class IsNullFunction extends AbstractFunctionExpression {
        ...
        private IsNullFunction(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        private static IsNullFunction from(final List<Expression> functionExpressionList) {
