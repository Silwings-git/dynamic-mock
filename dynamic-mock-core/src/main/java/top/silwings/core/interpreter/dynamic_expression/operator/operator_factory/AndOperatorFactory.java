...
public class AndOperatorFactory implements OperatorFactory {
    ...
    public static class AndOperator extends AbstractOperatorExpression {
        ...
        private AndOperator(final List<ExpressionTreeNode> functionExpressionList) {
            super(functionExpressionList);
        }

        public static AndOperator from(final List<ExpressionTreeNode> functionExpressionList) {
