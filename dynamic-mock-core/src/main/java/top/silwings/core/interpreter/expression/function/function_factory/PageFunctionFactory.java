...
public class PageFunctionFactory implements FunctionFactory {
    ...
    @Override
    public PageFunction buildFunction(final List<Expression> functionExpressionList) {
    ...
    public static class PageFunction extends AbstractFunctionExpression {
        ...
        private PageFunction(final List<Expression> functionExpressionList) {
            super(functionExpressionList);
        }

        private static PageFunction from(final List<Expression> functionExpressionList) {
