...
import cn.silwings.admin.web.vo.param.QueryFunctionInfoParam;
import cn.silwings.admin.web.vo.result.FunctionInfoResult;
...
public class FunctionController {
    ...
    public PageResult<FunctionInfoResult> query(@RequestBody final QueryFunctionInfoParam queryFunctionInfoParam) {
        ...
        final FunctionInfoResult dynamic = FunctionInfoResult.builder()
                ...
                .functionReturnType(cn.silwings.core.interpreter.dynamic_expression.function.FunctionReturnType.OBJECT)
