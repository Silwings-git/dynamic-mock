package cn.silwings.admin.web.setup;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.HttpMethod;
import org.springframework.stereotype.Component;
import cn.silwings.admin.web.controller.ProjectController;
import cn.silwings.admin.web.vo.param.MockHandlerInfoParam;
import cn.silwings.admin.web.vo.param.MockResponseInfoParam;
import cn.silwings.admin.web.vo.param.MockResponseParam;
...
public class SetUp {
    ...
    public static MockHandlerInfoParam buildHandler(final Identity project) {
        return MockHandlerInfoParam.builder()
                ...
                .httpMethods(Stream.of(HttpMethod.GET, HttpMethod.POST, HttpMethod.PUT, HttpMethod.DELETE, HttpMethod.HEAD, HttpMethod.PATCH).map(HttpMethod::name).collect(Collectors.toList()))
